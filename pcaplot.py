...
if __name__ == '__main__':
    ...
    rstfile = "RMSETCdata-pca.csv"
    gdrstfile = "RMSETCdata-pca.csv"
    ...
    ax1.set_xlabel("TC Err (from 112.1 W/(m·K) :300 K)", fontsize=12)
    ax1.set_ylabel(r'force/RMSE (meV/$\AA$)', fontsize=12)
    ax1.grid(True)
